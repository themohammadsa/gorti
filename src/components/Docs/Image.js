  ...
  return (
    <div className="component">
      ...
      <div className="component-sub">
        ...
        <img class="image-responsive shadow" src="https://dummyimage.com/250x250/c9c9c9/363636" alt="" />
        </div>
      ...
      <div className="component-sub">
        <h3>Round Image</h3>
        <div class="flex-row justify-space-evenly  component-box">
        <img class="image-round shadow" src="https://dummyimage.com/250x250/c9c9c9/363636" alt="" />
        </div>
