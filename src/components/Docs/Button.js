    ...
    <div className="component">
      ...
      <div className="component-sub">
        ...
        <div className="flex-row justify-space-evenly component-box">
          <button className="button button-primary shadow"> Home </button>
          <button className="button button-primary shadow"> About </button>
          <button className="button button-primary shadow"> Contact </button>
        </div>
      ...
      <div className="component-sub">
        ...
        <div className="flex-row justify-space-evenly  component-box">
          <button className="button button-secondary shadow"> Home </button>
          <button className="button button-secondary shadow"> About </button>
          <button className="button button-secondary shadow"> Contact </button>
        </div>
      ...
      <div className="component-sub">
        <h3>Icon Buttons</h3>
        <div className="flex-row justify-space-evenly  component-box">
          <button className="button button-icon shadow">
            <img
      ...
      <div className="component-sub">
        ...
        <div className="flex-row justify-space-evenly  component-box">
          <div className="avatar avatar-blue shadow">+</div>
          <div className="avatar avatar-blue shadow">×</div>
          <div className="avatar avatar-blue shadow">-</div>
        </div>
